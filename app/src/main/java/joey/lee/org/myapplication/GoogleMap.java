...
public class GoogleMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_energy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoogleMap.this, EnergyActivity.class);
        ...
        btn_battery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoogleMap.this, BatteryActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoogleMap.this, SettingsActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_dashboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoogleMap.this, DashboardActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_favorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick (View v) {
                Intent intent = new Intent(GoogleMap.this, FavoritesActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                ...
                // add marker new with filter
                // FavoritesActivity
                Intent intent = new Intent(GoogleMap.this, FilterActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(com.google.android.gms.maps.GoogleMap googleMap) {
        ...
        map.setOnMarkerClickListener(new com.google.android.gms.maps.GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                documentReference.addSnapshotListener(GoogleMap.this, new EventListener<DocumentSnapshot>() {
                    @Override
                    ...
                    searchMarker = map.addMarker(new MarkerOptions().position(marker.getPosition()));
                        ...
                        documentReference.set(station).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(GoogleMap.this,"Saved in History", Toast.LENGTH_SHORT).show();
                            }
                        });
                ...
                if(!tagMarker.equals("no")) {
                    ...
                    documentReference.set(station).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(GoogleMap.this,"Station marked", Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(GoogleMap.this,"Only stations can be marked", Toast.LENGTH_SHORT).show();
                }
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(searchMarker != null) {
                    ...
                    Toast.makeText(GoogleMap.this,"Select Location", Toast.LENGTH_SHORT).show();
                }
